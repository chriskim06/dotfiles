...
alias kdev='KREW_ROOT="$HOME/playground" $HOME/go/src/sigs.k8s.io/krew/out/bin/krew-linux_amd64'
alias kidev='KREW_ROOT="$HOME/playground" X_KREW_ENABLE_MULTI_INDEX=1 $HOME/go/src/sigs.k8s.io/krew/out/bin/krew-linux_amd64'
